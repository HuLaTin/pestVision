...
# if you are wanting to use GPU make sure to install the correct pytorch libraries
# if you download 'cpu only' then you will not be able to get cuda to work
...
# can ignore, or downgrade. shouldn't interrupt training

# training on 29 classes
# expect to run for a long time, >6 hours on 1 epoch on CPU
# 20 mins on 1070 gpu
